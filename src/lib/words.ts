...
const WORD_CLUES_BY_LOCALE: Record<Locale, Record<string, string>> = {
  en: {
    ...
    hotel: "A place where travelers sleep",
    llave: "You use this to open your room",
    cuarto: "A room",
    cama: "Where you sleep",
    ducha: "Where you wash",
    recepcion: "The hotel front desk",
    vuelo: "A trip by plane",
    puerta: "Your gate at the airport",
    boleto: "A ticket",
    maleta: "A suitcase",
    salida: "A departure or exit",
    taxi: "A car you hire for a ride",
    calle: "A street",
    cerca: "Nearby",
    lejos: "Far away",
