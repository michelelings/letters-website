...
export default function Page() {
  return (
    <ArticlePage
      ...
      breadcrumb={guideArticleBreadcrumb({ locale: "es", path: "/es/guides/por-que-aprender-vocabulario-con-juegos/", label: "Por qué aprender vocabulario con juegos funciona" })}
