    ...
    <>
      ...
      <nav className="article-related" aria-label="Guías relacionadas">
        ...
        <ul>
          ...
          <li><Link href="/es/guides/mejor-forma-aprender-vocabulario/">La mejor forma de aprender vocabulario (casual)</Link></li>
          <li><Link href="/es/guides/estrategias-vocabulario-dificil/">Estrategias para vocabulario difícil</Link></li>
